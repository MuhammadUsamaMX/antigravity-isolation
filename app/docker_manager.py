...
import os
import subprocess
from config import DOCKER_IMAGE_NAME, CONTAINER_PREFIX, ANTIGRAVITY_PROFILES_DIR
...
class DockerManager:
    ...
    def start_container(self, profile_name):
        """Start an Antigravity container for the profile"""
        ...
        volumes = {
            ...
            pulse_cookie: {'bind': '/home/antigravity/.config/pulse/cookie', 'mode': 'ro'},
            profile_dir: {'bind': '/home/antigravity/.config/antigravity', 'mode': 'rw'},
            downloads_dir: {'bind': '/home/antigravity/Downloads', 'mode': 'rw'}
        }
        
        environment = {
            'DISPLAY': os.environ.get('DISPLAY', ':0'),
            'PULSE_SERVER': 'unix:/run/user/1000/pulse/native',
            'PULSE_COOKIE': '/home/antigravity/.config/pulse/cookie',
            'ANTIGRAVITY_PROFILE': profile_name,  # Pass profile name for stealth fingerprinting
        ...
        container = self.client.containers.run(
            ...
            dns_opt=['ndots:0'],
            command=[
                f'--class=antigravity-{profile_name}',
                '--disable-gpu'
            ]
        )
